    ...
    click(e) {
      ...
      switch (types) {
        ...
        case "callPhone":
          ...
          break;
        case "openMap":
          let latlog = _that.data.siteList[_that.data.topSiteIndex].s_coordinate
            ? _that.data.siteList[_that.data.topSiteIndex].s_coordinate.split(
                ","
              )
            : ["", ""];
          my.openLocation({
            ...
            name: _that.data.siteList[_that.data.topSiteIndex].s_name, // 位置名称
        ...
        case "look":
          ...
          let markers = [];
          let siteLatLon = [];
          if (_that.data.siteList[index].s_coordinate) {
            siteLatLon = _that.data.siteList[index].s_coordinate.split(",");
          }
          markers.push({
      ...
      base.http.httpPost({
        ...
        success(res) {
          ...
          if (
            ...
            let markers = [];
            let siteLatLon = [];
            if (res.data.data[0].s_coordinate) {
              siteLatLon = res.data.data[0].s_coordinate.split(",");
            }
            markers.push({
              iconPath: "/res/icon_map_center.png",
              id: 1,
